...
<div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
  <div class="container">
    <div class="row align-items-end">
      <div class="col-lg-7">
        <h2 class="mb-0">Mixed School</h2>
        <p>Located In Kiserian.</p>
      </div>
    </div>
  </div>
</div> 
...
<a href="{{url('/')}}">Home</a>
  ...
  <span class="current" style="color: #D2691E">Primary School</span>
</div>
</div>
      ...
      <div class="row">
        <div class="col-lg-9">
           <div class="section-heading">
            <h3 class="text-black">Primary Mixed School</h3>
          </div>
          <div class="row">
            <div class="col-lg-6">
